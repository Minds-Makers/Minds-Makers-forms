import { FormSchemaJson } from "./schema";

export const blankFormSchema: FormSchemaJson = {
  intro: {
    eyebrow: "New form",
    headline: "Untitled form",
    headlineHighlight: "",
    lead: "",
    facts: [],
  ...
  steps: [{ id: "step_1", title: "Step 1", hint: "", questions: [] }],
};

export const compileStudentSurveySchema: FormSchemaJson = {
  intro: {
    eyebrow: "Minds Makers · Student research",
    headline: "Tell us what it takes to get job-ready.",
    headlineHighlight: "job-ready.",
    lead:
      "We're Minds Makers, testing an idea called Compile: a platform where you complete tasks inside a simulated company to build real, documented work experience before you graduate. Before we build anything, we want to understand your situation.",
    facts: [
  ...
  steps: [
    {
      ...
      questions: [
        ...
        },
        {
          id: "university",
          type: "text",
          label: "University and faculty",
          placeholder: "e.g. Cairo University, Faculty of Computers",
        },
        {
          id: "track",
          type: "single",
          label: "Your major or track",
          options: [
            "Computer Science",
            "Information Systems",
            "AI",
        ...
        },
        {
          ...
          options: [
            ...
            "Working in tech already",
            "Graduated, job hunting",
      ...
      questions: [
        {
          id: "has_experience",
          type: "single",
          label: "Do you have any real hands-on work experience?",
          options: [
            "Yes, a paid or formal internship",
            "Yes, an unpaid internship or volunteering",
            "Yes, freelance or personal projects only",
            "No, none yet",
          ],
        },
        {
          ...
          type: "multi",
          label: "If yes — where did that experience come from? (select all that apply)",
          options: [
            "A company internship",
            "A university-arranged program",
            "A personal project I built alone",
            "Freelance work",
            "Open-source contributions",
            "A coding bootcamp with real projects",
            "Other",
          ],
          allowOther: true,
        },
        {
          ...
          type: "single",
          label:
            "How confident are you that you could handle real day-to-day tasks at a junior dev job right now?",
      ...
      questions: [
        {
          id: "problems_scale",
          type: "scales",
          label: "How much of a problem is each of these for you?",
          low: "Not a problem",
          high: "A major problem",
          items: [
        ...
        },
        {
          ...
          type: "textarea",
          optional: true,
          label: "Any other problem not listed here?",
      ...
      questions: [
        {
          id: "tools",
          type: "multi",
          label: "What do you currently use to prepare for the job market? (select all that apply)",
          options: [
        ...
        },
        {
          ...
          type: "textarea",
          optional: true,
          label: "What's missing or frustrating about these?",
          placeholder: "Write freely",
        },
        {
          id: "past_platform",
          type: "single",
          label: "Have you tried a platform like this before (job-simulation or practical training)?",
    ...
    },
    {
      ...
      hint:
        "This is Compile: you join a fictional company and complete realistic tasks — tickets, features, bug fixes — under deadlines and feedback, before you graduate. It's not built yet, so your honest opinion matters more than encouragement.",
      questions: [
        {
          id: "value_scale",
          type: "scales",
          label: "How valuable would each part of this be to you?",
          low: "Not valuable",
          high: "Very valuable",
          items: [
        ...
        },
        {
          id: "would_use",
          type: "single",
          label: "If this existed today, would you use it?",
        ...
        },
        {
          ...
          type: "textarea",
          optional: true,
          label: "Anything you'd want from something like this that we haven't mentioned?",
          placeholder: "Write freely",
        },
      ],
    },
      ...
      questions: [
        {
          id: "would_try",
          type: "single",
          label: "If a free trial version launched, would you try it?",
        ...
        },
        {
          ...
          type: "email",
          optional: true,
          label: "Want us to reach out when the trial is ready? Leave your email",
          hint: "We'll only use it to contact you about this project.",
  ...
  consent: {
    ...
    options: [
      {
        value: "yes",
        label: "I agree that my answers may be used, in aggregate, for this project's research.",
      },
    ],
  },
};
